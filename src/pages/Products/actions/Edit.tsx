...
function Edit(props: EditProps) {
  ...
  const onFinish = async (data: FormValues) => {
    ...
    formData.append('type', (data.type !== undefined ? data.type : dataProduct?.type) || '');
    ...
    >
      ...
      <div className="p-4">
        <Form form={form} className="flex flex-col gap-6" onFinish={onFinish}>
          ...
          <div className="flex items-center h-[40px]">
            <p className="w-[120px] text-left text-[#0071BA]">Loại sản phẩm</p>
            <Form.Item
              className="!mb-0 w-full"
              name="type"
              rules={[
            ...
            >
              <Select>
                <Select.Option value="VitaminKhoangChat">VitaminKhoangChat</Select.Option>
                <Select.Option value="DieuTriBenhLy">DieuTriBenhLy</Select.Option>
                <Select.Option value="ChamSocCaNhan">ChamSocCaNhan</Select.Option>
              </Select>
            </Form.Item>
          </div>
          <div className="flex items-center h-[40px]">
