...
function AddNews(props: AddNewsProps) {
  ...
  return (
    <Modal
      ...
      footer={false}
    >
      <div className="w-full text-center p-3 h-[60px] leading-[36px] bg-[#24652c] rounded-t-lg uppercase font-bold">Thêm Tin tức</div>
      <div className="p-4">
        <Form form={form} className="flex flex-col gap-6" onFinish={onFinish}>
          <div className="flex items-center h-[40px]">
            <p className="w-[120px] text-left text-[#24652c]">Tiêu đề</p>
            <Form.Item
          ...
          <div className="flex items-center flex-col">
            <div className="flex items-center w-full h-full">
              <p className="w-[120px] text-left text-[#24652c]">Hình ảnh</p>
              <Form.Item
                className="!mb-0 w-full"
                name="images"
                rules={[
          ...
          <div className="flex items-center">
            <p className="w-[106px] text-left text-[#24652c]">Nội dung</p>
            <Editor
